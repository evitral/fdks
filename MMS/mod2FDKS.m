...
%---------------------------------------------------------------%
    ...
    cot = cos(at*pi()*(double(t)*dtau)/(tmax+dtau));
    sit = sin(at*pi()*(double(t)*dtau)/(tmax+dtau));
...
%---------------------------------------------------------------%
    ...
    for x = 0:dX:L
        ...
        +ht*sin(at*pi()*(double(t)*dtau)/(tmax+dtau));
    end
    end
